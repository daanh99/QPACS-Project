...
cloud_info_list = [
    GoogleCloudInfo('sajvanleeuwen', 'image-1', 'keys/sander.json', 'keys/sander_ssh_key', 48),
    GoogleCloudInfo('daanhofman', 'image-1', 'keys/daan.json', 'keys/daan_ssh_key', 32),
    GoogleCloudInfo('kawin_zheng', 'image-1', 'keys/kawin.json', 'keys/kawin_ssh_key', 52),
]
